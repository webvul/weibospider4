package org.cheetyan.weibospider.model.sina;
...
public class Status implements java.io.Serializable {
	...
	private static Logger logger = LoggerFactory.getLogger(Status.class.getName());
	//
	@ManyToOne(targetEntity = User.class, cascade = CascadeType.ALL)
	@JoinColumn(name = "user_id")
	private User user; // * 作者信息,not null,
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "url", column = @Column(name = "source_url")), @AttributeOverride(name = "relationShip", column = @Column(name = "source_relationShip")),
	...
	public Status(String str) throws JsonException, WeiboException {
	...
	public String toString() {
		return "Status [user=" + user + ", idstr=" + idstr + ", createdAt=" + createdAt + ", id=" + id + ", text=" + text + ", source=" + source + ", favorited=" + favorited + ", truncated=" + truncated + ", inReplyToStatusId=" + inReplyToStatusId
